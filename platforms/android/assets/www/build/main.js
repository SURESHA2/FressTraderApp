...
var WalletPage = (function () {
    function WalletPage(userData, navCtrl, nav, toastCtrl, events, menuCtrl, navParams, setupService, loadingCtrl, alertCtrl, barcodeScanner, platform) {
        var _this = this;
        this.userData = userData;
        this.navCtrl = navCtrl;
        this.nav = nav;
    ...
    ///////////////////////////////////////
    // showConfirm(){
    //  var btcAddress= this.getAddress;
    //  console.log("btcaddress = ="+this.getAddress);
    ...
    //        text: 'copy',
    //        handler: data => {   
    //             this.btcAddress.copy(btcAddress);
    //        }
    //      },
    //      {
    //        text: 'Cancel',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__ionic_native_clipboard__ = __webpack_require__(367);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
