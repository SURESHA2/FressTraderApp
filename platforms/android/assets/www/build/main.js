...
var ForgotpasswordPage = (function () {
    ...
    ForgotpasswordPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-forgotpassword',template:/*ion-inline-start:"F:\Ionic_Project\StreetxTrader_App\src\pages\forgotpassword\forgotpassword.html"*/'<ion-header>\n\n	<ion-navbar>\n\n		<ion-title>Forgot Password</ion-title>\n\n	</ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n	<div padding-top text-center >\n\n        <img src="http://www.gravatar.com/avatar?d=mm&s=140" alt="avatar">\n\n    \n\n	<form #forgotPasswordForm="ngForm" novalidate>\n\n\n\n		<ion-list no-lines>\n\n			<ion-item>\n\n				<ion-label stacked class="button-color">Email Id</ion-label>\n\n				<ion-input [(ngModel)]="emailId.email" placeholder="Enter your Email Id" name="email" type="text" #email="ngModel" spellcheck="false" autocapitalize="off"\n\n					required>\n\n				</ion-input>\n\n			</ion-item>\n\n			<p ion-text [hidden]="email.valid || submitted == false" color="danger" padding-left>\n\n				Email Id is Required\n\n			</p>\n\n		</ion-list>\n\n    <ion-row responsive-sm>\n\n          <ion-col>\n\n				<button class="button-backcolor" ion-button (click)="forgotPassword(forgotPasswordForm)" type="submit" block>Submit</button>\n\n			</ion-col>\n\n	</ion-row> \n\n		\n\n	</form>\n\n</div>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"F:\Ionic_Project\StreetxTrader_App\src\pages\forgotpassword\forgotpassword.html"*/,
        }),
...
var SetupService = (function () {
    ...
    SetupService.prototype.createstxWalletDetail = function (email) {
        var response = this.http.post(this.endpoint_url + '/coininr/getBalBCH', email).map(function (res) { return res.json(); });
        return response;
    };
    //Address details
    ...
    SetupService.prototype.createstxAddressDetail = function (email) {
        var response = this.http.post(this.endpoint_url + '/coininr/getNewBCHAddress', email).map(function (res) { return res.json(); });
        return response;
    };
    ...
    SetupService.prototype.createstxTransactionDetail = function (email) {
        var response = this.http.post(this.endpoint_url + '/coininr/getTxsListBCH', email).map(function (res) { return res.json(); });
        return response;
    };
    // for send page
    ...
    SetupService.prototype.createstxSendDetail = function (sendstxdetails) {
        var response = this.http.post(this.endpoint_url + '/coininr/sendBCH', sendstxdetails).map(function (res) { return res.json(); });
        return response;
    };
    ...
    SetupService.prototype.changeSpendingPasswords = function (passwordValues1) {
        var response = this.http.post(this.endpoint_url + '/trader/updateSpendingPassword', passwordValues1).map(function (res) { return res.json(); });
        return response;
    };
    ...
    SetupService.prototype.forgotPassword = function (emailId) {
        var response = this.http.post(this.endpoint_url + '/trader/sentOtpToEmailForgotPassword', emailId).map(function (res) { return res.json(); });
        return response;
    };
...
var ChangepasswordPage = (function () {
    ...
    ChangepasswordPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-changepassword',template:/*ion-inline-start:"F:\Ionic_Project\StreetxTrader_App\src\pages\changepassword\changepassword.html"*/'<ion-header>\n\n	<ion-navbar>\n\n		<button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n		<ion-title>Change Password</ion-title>\n\n	</ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content class="login-page">\n\n\n\n	\n\n\n\n	<form #changePasswordForm="ngForm" novalidate>\n\n		<ion-list no-lines>\n\n			<ion-item>\n\n				<ion-label stacked color="primary">New Password</ion-label>\n\n				<ion-input [(ngModel)]="newPasswordvalue.newPassword" placeholder="enter new password"name="newPassword" type="text" #newPassword="ngModel" required>\n\n				</ion-input>\n\n			</ion-item>\n\n			<p ion-text [hidden]="newPassword.valid || submitted == false" color="danger" padding-left>\n\n				new password is required\n\n			</p>\n\n\n\n			<ion-item>\n\n				<ion-label stacked color="primary">Confirm New Password</ion-label>\n\n				<ion-input [(ngModel)]="newPasswordvalue.confirmNewPassword" placeholder="enter confirm new password" name="confirmNewPassword" type="password" #confirmNewPassword="ngModel" required>\n\n				</ion-input>\n\n			</ion-item>\n\n			<p ion-text [hidden]="confirmNewPassword.valid || submitted == false" color="danger" padding-left>\n\n				confirm new password is required\n\n			</p>\n\n		</ion-list>\n\n		<div padding>\n\n			<button ion-button (click)="changecurrentPassword(changePasswordForm)" type="submit" block>submit</button>\n\n		</div>\n\n	</form>\n\n\n\n</ion-content>\n\n\n\n'/*ion-inline-end:"F:\Ionic_Project\StreetxTrader_App\src\pages\changepassword\changepassword.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* ToastController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* MenuController */],
...
var SettingPage = (function () {
    function SettingPage(navCtrl, alertCtrl, toastCtrl, _setupService, loadingCtrl, platform) {
        ...
        this.passwordValue1 = { "userMailId": "", "oldspendingpassword": "", "newSpendingPassword": "", "confirmNewPassword": "" };
    ...
    // change Spendign password
    SettingPage.prototype.changeSpendingPassword = function () {
        var _this = this;
        var prompt = this.alertCtrl.create({
            title: ' Change Spending Password',
            inputs: [
                {
                    name: 'oldspendingpassword',
                    type: 'password',
                    placeholder: 'Current Spending Password',
                },
                {
                    name: 'newSpendingPassword',
                    type: 'password',
                    placeholder: 'New Spending Password',
                },
                {
                    name: 'confirmNewPassword',
                    type: 'password',
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function (data) {
                        var loading = _this.loadingCtrl.create({
                            content: 'Updating OldSpending Password...'
                        });
                        loading.present();
                        _this.passwordValue1.userMailId = _this.userEmail.email;
                        _this.passwordValue1.oldspendingpassword = data.oldspendingpassword;
                        _this.passwordValue1.newSpendingPassword = data.newSpendingPassword;
                        _this.passwordValue1.confirmNewPassword = data.confirmNewPassword;
                        _this._setupService.changeSpendingPasswords(_this.passwordValue1).subscribe(function (response) {
                            if (response.statusCode == 200) {
                                loading.dismiss();
                                var toast = _this.toastCtrl.create({
                                    message: 'Spending Password Change successfully',
                                    showCloseButton: true,
                                    closeButtonText: 'Ok',
                                    duration: 5000
                                });
    ...
    SettingPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-setting',template:/*ion-inline-start:"F:\Ionic_Project\StreetxTrader_App\src\pages\setting\setting.html"*/'<!--\n\n  Generated template for the SettingPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar>\n\n     <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>Settings</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n<div padding-top text-center >\n\n    <img src="http://www.gravatar.com/avatar?d=mm&s=140" alt="avatar">\n\n\n\n    <ion-list inset>\n\n\n\n          <span style="margin-right: 50px " > <strong>Account verify</strong></span>\n\n          <br>{{userEmail.email}}\n\n          <span (click)="veryfyEmail(userEmail.email)" class="pull-left red-text" *ngIf="verifyEmail==false"> Not Verified</span>\n\n          <span class="pull-right green-text" *ngIf="verifyEmail==true"> Verified</span><hr>\n\n          <button ion-item (click)="changeCurrentPassword()">Change Password</button><hr>\n\n           <button ion-item (click)="changeSpendingPassword()">Change Spending Password</button><hr>\n\n\n\n    </ion-list>\n\n  </div>\n\n</ion-content>\n\n'/*ion-inline-end:"F:\Ionic_Project\StreetxTrader_App\src\pages\setting\setting.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* ToastController */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__sends_sends__ = __webpack_require__(240);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_barcode_scanner__ = __webpack_require__(241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_clipboard__ = __webpack_require__(242);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var WalletPage = (function () {
    ...
    WalletPage.prototype.getAddress = function () {
        var _this = this;
        this.setupService.createAddressDetail({ email: this.userEmail.email }).subscribe(function (result) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_observable_of__ = __webpack_require__(347);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__app_component__ = __webpack_require__(325);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__pages_sends_sends__ = __webpack_require__(240);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__ionic_native_geolocation__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__providers_conference_data__ = __webpack_require__(243);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__providers_user_data__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26_ngx_qrcode2__ = __webpack_require__(349);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__ionic_native_barcode_scanner__ = __webpack_require__(241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__ionic_native_clipboard__ = __webpack_require__(242);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_22__pages_sends_sends__["a" /* SendsPage */]
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["f" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_8__app_component__["a" /* ConferenceApp */], {}, {
                    links: [
                        ...
                        { component: __WEBPACK_IMPORTED_MODULE_18__pages_setting_setting__["a" /* SettingPage */], name: 'SettingsPage', segment: 'setting' },
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_24__providers_conference_data__["a" /* ConferenceData */], __WEBPACK_IMPORTED_MODULE_23__ionic_native_geolocation__["a" /* Geolocation */],
                __WEBPACK_IMPORTED_MODULE_25__providers_user_data__["a" /* UserData */], __WEBPACK_IMPORTED_MODULE_16__providers_setup_services__["a" /* SetupService */], __WEBPACK_IMPORTED_MODULE_6__ionic_native_status_bar__["a" /* StatusBar */],
                __WEBPACK_IMPORTED_MODULE_4__ionic_native_in_app_browser__["a" /* InAppBrowser */],
                __WEBPACK_IMPORTED_MODULE_5__ionic_native_splash_screen__["a" /* SplashScreen */],
                __WEBPACK_IMPORTED_MODULE_27__ionic_native_barcode_scanner__["a" /* BarcodeScanner */], __WEBPACK_IMPORTED_MODULE_28__ionic_native_clipboard__["a" /* Clipboard */]
            ]
        })
    ], AppModule);
    return AppModule;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__providers_conference_data__ = __webpack_require__(243);
...
var SignupPage = (function () {
    function SignupPage(navCtrl, loadingCtrl, userData, alertCtrl, menuCtrl, navParams, _setupService, toastCtrl, platform) {
        ...
        this.signup = { fullName: '', mobileNumber: '', email: '', password: '', confirmPassword: '', spendingpassword: '', confirmspendingpassword: '' };
        this.submitted = false;
        var backAction = platform.registerBackButtonAction(function () {
            _this.navCtrl.pop();
            backAction();
...
var DashboardPage = (function () {
    ...
    // update INR values 
    DashboardPage.prototype.updateSTX = function (form) {
